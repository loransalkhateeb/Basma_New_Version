...
//       // Process video files and links
//       const videoFileData = videos.map((file, index) => ({
//         id: req.body[`id[${index}]`] || null,
//         title: req.body[`title[${index}]`] || file.originalname.split(".")[0],
//         url: file.filename,
//         type: "file",
//         course_id: courseId
//       }));
  
//       const videoLinkData = normalizedLinks.map((link, index) => ({
//         id: null,
...
//             const duration = await getVideoDurationInSeconds(videoPath).catch(
//               () => 0
//             );
//             return {
//               ...video,
...
//             };
//           } else {
//             return { ...video, duration: "0h 0m 0s", url: null };
//           }
//         })
//       );
  
//       for (const video of processedVideoData) {
//           if (processedVideoData.length > 0) {
//           await Video.update(video, { where: { id: video.id } });
//         } else {
...
//       const totalDurationInSeconds = allVideos.reduce(
//         (total, video) => total + parseDurationInSeconds(video.duration),
//         0
//       );
